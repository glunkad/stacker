...
def main():
    ...
    drop_loc2 = ([(16.31,-6.55,4.25),(16.31,-6.55,2.25),(16.31,-6.55,5.25),(0,0,5.25)],[(58.5,63.74,4.25),(58.5,63.75,2.25),(58.5,63.75,5.25), (0,0,5.25)])
    d1,d2 = Drone(e1,drop_loc1), Drone(e2,drop_loc1)
    # row_nos = []
    # b = Boxes()
    # b.row_nos()
    # row_nos = b.box_loc
