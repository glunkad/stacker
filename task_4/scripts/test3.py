...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        start_search = 1 
        while start_search:
            x1,y1,z1 = pos.pose.position.x,pos.pose.position.y,pos.pose.position.z = stateMt.pos.pose.position.x + 2.5 , stateMt.pos.pose.position.y, stateMt.pos.pose.position.z
            local_pos_pub.publish(pos)
            temp = 0
